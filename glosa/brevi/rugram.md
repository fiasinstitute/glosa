...
E. Маркеры Существительного (Noun Markers)
  i. Указывая на начало Фразы_Существительного (Noun Phrase), эти частицы 
...
F. Предлоги (Prepositions)
  i. Небольшие слова, которые дают информации о следующей 
     Фразе_Существительного (Noun Phrase) или Наречном_Предложении 
     (Adverbial Clause):
 ...
 ii. Небольшие слова, которые вводят Наречное_Предложение (Advebial Clause):
...
G. Модификаторы
  ...
  i. Не изменяя своей формы, одно и то же слово может модифицировать
     ...
     как наречие).
 ii. Во Фразах_Существительного, есть также модификаторы Числа, 
...
iii. Вопросы
 ...
 iv. Обобщенные Термины (Generic Terms)
  ...
  v. Рефлексивные (возвратные) формы (Reflexive Forms)
    ...
    b) Для безличных Подлежащих, после 'глагола' ставится ~se~, или ~-se~.
...
## 5. Фразы_Существительного (Noun Phrases)
 ...
 J. Содержательное слово как 'существительное'
   Простое предложение имеет две Фразы_Существительного (NP = Noun Phrase),
...
ii. Альтернативно, во Фразе_Существительного может быть множество 
...
L. Детерминанты (Determinants) и Нумераторы (Numerators) 
   ...
   и ставятся в начале Фразы_Существительного.
