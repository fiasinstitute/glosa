...
<P Align="Right"><FONT Color="Green"> U-ci pagina du gene stru. Id ne pa gene fini a-nu.
</FONT> <IMG src="../pic/at-work2.gif">
</P>
<HR>
...
<P><I><FONT Color="Green"> [Ex bibli "Español Glosa 1000" ex Richard Burrows, Wendy Ashby e Ron Clark, © GEO, Richmond UK 1992, ISBN 0 946540 18 7. 

 Tu pote merka u bibli ex: Glosa Education Organisation, 35 Wingfield Road; Kingston Upon Thames; Surrey KT2 5LR; ENGLAND. 

 HTML-versio ex Marcel Springer, 2004.]

<!-- English: [From the book "Español Glosa 1000" by Richard Burrows, Wendy Ashby and Ron Clark, © GEO, Richmond UK 1992, ISBN 0 946540 18 7. 

 You can buy the book from: Glosa Education Organisation, 35 Wingfield Road; Kingston Upon Thames; Surrey KT2 5LR; ENGLAND. 

 HTML-version by Marcel Springer, 2004. Many thanks to ... for his help with the Spanish language.]
-->
<!-- Spanish: [Del libro "Español Glosa 1000" de Richard Burrows, Wendy Ashby y Ron Clark, © GEO, Richmond UK 1992, ISBN 0 946540 18 7. 
...
| 
 ...
 <FONT SIZE=+4> ESPAÑOL </FONT>
 
 <FONT SIZE=+6>** GLOSA 1000**</FONT> 
...
<P><I><FONT Color="Green"> [U titula-pagina monstra uno exempla de Glosa-verba ko mu EspaÃ±ol kognati-verba. Tu pote vide mu <A HREF="esintra.htm#exempla">infra.</A>]

<!-- English: [The title page shows some examples of Glosa words with their Spanish cognates. You can see them <A HREF="#exempla">below.</A>]
-->
...
<P> Escrito por Richard Burrows, MIL 
...
<H3>¡EL  IDIOMA  INTERNACIONAL  QUE 
YA  SABES!</H3>

<UL>
<LI> Las comunicaciones modernas están cambiando este mundo en que vivimos. Se transforma en un 'Pueblo Mundial' - y a los habitantes, nada más seguro de que les hace falta un Idioma Universal. 


<LI> Este idioma se llama GLOSA. **¡Es tan fácil! ¡Es tan rico!** Aprenderás como hablarlo y escribirlo dentro de una hora. Sí, en una hora. 


<LI> Luego, lo hablarás y escribirás lenta pero verdaderamente sobre cualquier tema, **porque no hay nada realmente nuevo para ti en GLOSA.** 


<LI> **GLOSA tiene miles de palabras que se originaron en el latín y el griego clásicos...** igual que español. La misma palabra GLOSA se ve en la palabra española 'GLOSArio', entre otras. En un vocabulario de palabras de la mayor utilidad. GLOSA 1000 consta de la más básicas de éstas, cuidadosamente elegidas. Combinándolas, hablarás y escribirás en la vida cotidiana, o bien de la ciencia, la tecnología, las letras. 


<LI> Las palabras de **GLOSA 1000** son generalmente bastante cortas, ya que carecen de todas aquellas terminaciones gramaticales que 'adornaban' los idiomas antiguos pero que hoy, en un idioma internacional, no sirven para nada. Por lo tanto, GLOSA se puede hablar y escribir con facilidad y rapidez... muy importantes en el mundo de hoy. 


<LI> **Y cuando decimos 'internacional', no queremos decir sólo para los países europeos.** Ni mucho menos. ¿Sabías que la nación quizás más avanzada del mundo oriental, los japoneses, ha integrado en su lengua unas diez mil palabras de origen griego-latin? Lo mismo ocurrirá en los demás idiomas, naturalmente. 
...
<P> Glosa simplifica, mejora y facilita la comunicación
...
<P> No sólo para la comunicación internacional se
...
relación con palabras españolas. </P>

<P> FE en Glosa siginifica 'ella', como se comprenderá en
...
Fotografía es en efecto 'escritura con luz'. </P>
...
Por eufonía, U se convierte en UN delante de vocal. </P>
...
DE = de, igual que en español. </P>

<P> AUTO = 'sí mismo/a', que se ve en muchas palabras
modernas: 
...
<P> BIO = 'vida', como en 'BIOlogía' (estudio de seres y
animales vivos). </P>

<P> ¡Ya hemos compuesto una frase entera en GLOSA, sin darnos
cuenta! 
...
<H3>CARACTERÍSTICAS  DE  GLOSA</H3>

<H4>Vocabulario</H4>

<P> Ya sabes la mayoría de las palabras Glosas. Sí, de
...
<P> Lo mismo sucede con la mayoría de los conceptos que tengan
...
<P><I><FONT Color="Green"> [Plu exempla de titula-pagina:]

<!-- English: [Examples from the title page:]
-->
...
| |||
| **RODO  DENDRO**   
 <!-- original was: RHODO DENDRO -->   rosa   árbol    
 | ** AKRO  POLIS**
 cumbre  ciudad |**KLI nik**
 cama      |
| |||
|**TERMO  METRI**
 <!-- original was: THERMO METRI -->     calor  medir |**  SATIs  FACEr**
 <!-- original was "SATIsfy", but it is no Spanish sample --> suficiente  hacer   </TD><!-- original was only "suficiente" --> <TD>**kas KADE**
       caer |
| |||
|**   DIA  METRI**
...
| |||
|**PAN  ORAMA**
 toda    **VISTA**    </TD><!-- original was toda vista --> <TD>**DEMO  KRATI  **
 gente  gobernar |**     KALI  EIDO  SKOPE**
 <!-- original was KAL EIDO SKOPE --> hermosas  formas  mirar |
| |||
|**TELE   FONO**
 <!-- original was: TELE FONE --> distante  sonido|**PERI   SKOPE**
...
| |||
|**DEINO  SAURUS**
 <!-- original was: DEINO SAUR --> terrible   lagarto|**GINA eco LOGI**
 mujeres   comprender |**PAR     ALELO   **
 junto   uno al otro |
| |||
|**MIKRO  SKOPE**
 pequeño   mirar|**   EPI  DERMA**
 <!-- original was: EPI DERMIS --> sobre    piel |**MIRA culo**
 milagro       |
| |||
|**FILO    SOFI **
 amar  sabiduría|**  POLI  TEKNO**
 <!-- original was: POLI TEKNIK --> muchas  destrezas |**SEISMO    LOGI     **
...
<P> Las dos cosas que más desaniman a los estudiantes de
idiomas son: </P>

<UL>
<LI> la **declinación** (= cambios en la forma de los nombres y adjectivos para indicar su 'caso' gramatical), y
<LI> la **conjugación** (= cambios en la forma de los verbos para indicar la 'persona', el número, el tiempo, el modo, y otras nociones).
</UL>
...
<P>**<I> Está claro que no hay la más mínima
dificultad en cuanto a esto. </I>**</P>
...
<P>**Orden de Palabras.** Para expresar nuestras ideas clara y
...
<OL>
<LI> las partes de la oración vienen en el orden fijo S V O (Sujeto - Verbo - Objeto); y
<LI> los adjetivos vienen siempre delante del nombre que modifican, en el orden Aj N.
</OL>



<P>**Palabras funcionales.** Para expresar las demás y
...
<H2>PRONUNCIACIÓN  Y  ALFABETO </H2>
...
<P>**Pronunciación de las Vocales**
...
<P>**diptongos (a) cualquier combinación de dos vocales donde
al menos una de ellas es I o U; 

(b) AE se pronuncia como si fuera AI, y OE como si fuera OI;**</P>

<P>**hiatos** cualquier combinación de dos vocales que no
contenga ni I ni U, menos AE y OE. </P>

<P>**Pronunciación de las Consonantes**

Igual que en español: D F K L M N P R T 

Parecidas al español: </P>
...
<LI> H sola representa una ligera aspiración (pronunciación antigua o gitana de 'hondo');
<LI> X se dice siempre como 'ks' (algo difícil en posición inicial);
<LI> J es casi una semiconsonante, y tiene el sonido de 'hi' en posición inicial (de 'hielo').
</UL>

<P> Mucho cuidado con: C, que es igual que la 'ch' española.
</P>
...
<P> palabras agudas, si la sílaba acentuada es la
última; 
...
<P> En GLOSA, la inmensa mayoría de las palabras son llanas.
...
<P>**Entre Palabras: hiato sí, sinalefa no**
...
fonética entre un par de rayitas oblicuas /.../. </P>
...
<P>**Resumen de Cosas importantes**
...
<P ALIGN="Center"><I>p. 9:</I></P>

<H2>17  GENÉRICOS  TÉRMINOS </H2>
...
|12 |mo bi |
|20 |bi ze |
|50 |penta ze <!-- original was: pen ze --> |
|92 |nona bi |
|100 |mo hekto <!-- original was: mo centi --> |
|1000 |mo kilo |
|millón |miliona |
|10 elevado al 6    |deka a sixa <!-- original was: dek a six --> |
|5/8, 5 sobre 8 |penta supra okto <!-- original was: pen su ok --> |
|3,2 |tri koma bi |
|+ |plus |
|- |minus |
|*, por |para |
|3 * 4 = 12 |tri para tetra <!-- original was: tet --> eqa mo bi |
|dividir |divide |
...
|cuéntelos |Numera mu |
|el 8 de junio |di okto, <!-- original was: ok --> meno sixa <!-- original was: six --> |
|lunes |di bi |
|fecha |datu |
...
lingüísticos importantes. </P>

<P> Cada palabra Glosa expresa una idea o concepto - por lo tanto
se puede equiparar con muchas palabras españolas casi
sinónimas. </P>

<P> La mayoría de las palabras Glosas pueden funcionar como
Cualquier parte de la oración gramatical. </P>
...
la cosa que recibe la acción del verbo). </P>
...
|Menos que cien |MEI  DE  HEKTO <!-- original was: CENTI --> |
| ||
...
enfático, se traduce por AUTO. </P>
...
<P>En cualquier conversación, sea charla entre amigos o
...
<H3>Y  AHORA  TÚ;  ¡ECHA  A 
HABLAR!</H3>

<P>Usando lo expuesto en las páginas 5 a 17
...
<H2>EL  SÍMBOLO  GLOSISTA 
<IMG src="../pic/g18s031.gif">
</H2>

<P>**El símbolo representa la red mundial de las
...
difíciles de aprender. </P>

<P>Los puntos de intersección en el símbolo son los
...
<P>**MEGA-GLOSA** que incluirá todas las raíces del
vocabulario científico-tecnológico de uso común
en los idiomas modernos. </P>

<P>El símbolo es abierto hacia arriba para señalar que
...
<!-- English: [In the original book, here on page 13, there is the section "MANEJO DEL DICCIONARIO, USO DE SÍMBOLOS DE PUNTUACIÓN" concerning the word list of p. 18-43.
 The word list is missing in this document, but you will find a redacted version of it on <A HREF="../gid/index.html">http://www.glosa.org/gid</A>.
 The book continues: ...]
-->

</FONT></I></P>

<P>Estas partículas no aparacen en la sección
...
<P> El guión (-) en las columnas de palabras GLOSAS se usa para
...
<P><I><FONT Color="Green"> Un ur-bibli monstra ci epi pagina 14 mero de kapitula 28 de bibli "El sombrero de tres picos" ex P. A. de AlarcÃ³n, 1874. U textu habe bi paraleli kolumna EspaÃ±ol e Glosa. Id es in inter-reti a <A HREF="estextu.htm#sombrero"> http://www.glosa.org/brevi/estextu.htm#sombrero</A>.]

<!-- English: [The original book shows here on page 14 a part of chapter 28 of the book "El sombrero de tres picos" by Pedro Antonio de Alarcón, 1874. The text is in two parallel columns Spanish and Glosa. It is online available at <A HREF="estextu.htm#sombrero"> http://www.glosa.org/brevi/estextu.htm#sombrero</A>.]
-->
...
<P><I><FONT Color="Green"> Un ur-bibli monstra ci epi pagina 15 "Psalmus 23" in bi paraleli kolumna Espa ol e Glosa. U textu es in inter-reti a <A HREF="estextu.htm#psalmus"> http://www.glosa.org/brevi/estextu.htm#psalmus</A>.]

<!-- English: [The original book shows here on page 15 "Salmo 23" in two parallel columns Spanish and Glosa. The text is online available at <A HREF="estextu.htm#psalmus"> http://www.glosa.org/brevi/estextu.htm#psalmus</A>.]
-->
...
<P> In **jurnala "Plu Glosa Nota"** pe monstra; per uti 1000-ci
...
<P>**Glosa Education Organisation (GEO)**</P>
...
<P>U GEO jurnala ge-nima **"Eduka-Glosa"** emfasi; Glosa es un IAL;
...
<P>R. CLARK & W. ASHBY 
 ...
 Kingston Upon Thames 
 Surrey KT2 5LR 
 ENGLAND <!-- original book: "P.O. Box 18 ... TW9 2AU" --> 
...
<H2>ESPAÑOL - GLOSA 1000</H2>

<P>El número de radicales grecolatinos en el léxico de
todos los idiomas europeos, incluyendo el ruso y los demás
idiomas eslavos, es considerable, y en aumento continuo. El
catedrático ingles Lancelot Hogben afirma: </P>

<BLOCKQUOTE>"El vocabulario científico es la mejor
...
<P>Simeon Potter, catedrático de inglés, está de
acuerdo: </P>
...
<P>**Glosa 1000** es una forma desarrolada y simplificada del
...
<P><I><FONT Color="Green"> [Plu seqe stria habe relatio a verba-lista pagina 18 a 43.
 U verba lista minus in u-ci dokumenta, sed tu pote detekti u ge-ergo versio de id epi <A HREF="../gid/index.html">http://www.glosa.org/gid</A>.]

<!-- English: [The following lines belong to the the word list p. 18-43.
 The word list is missing in this document, but you will find a redacted version of it on <A HREF="../gid/index.html">http://www.glosa.org/gid</A>.]
-->

</FONT></I></P>

<P>**Este diccionario** expresa las 2000 palabras
españolas más útiles en el vocabulario
fundamental del Glosa 1000. </P>

<P>En la columna de Glosa, las palabras que vienen detrás del
...
<P><I><FONT Color="Green"> [In ur-bibli, ci epi pagina 18 a 43 il es verba-lista Español-Glosa.
 U verba lista minus in u-ci dokumenta, sed tu pote detekti u ge-ergo versio de id epi <A HREF="../gid/index.html">http://www.glosa.org/gid</A>.]

<!-- English: [In the original book, on page 18 to 43 there is the word list Spanish-Glosa.
 The word list is missing in this document, but you will find a redacted version of it on <A HREF="../gid/index.html">http://www.glosa.org/gid</A>.]
-->
...
<H3> <A HREF="../en/g18s.htm">18  STEPS  TO  FLUENCY  IN  EURO-GLOSA</A>
</H3>

<P>(18 Lecciones para Hablar Glosa con Soltura)</P>

<P>Escrito por: Wendy Ashby & Ron Clark. Publicado 1992

ISBN 0 946540 15 2. 108 páginas,
rústica. </P>

<P>**Contenido:** Cada lección tiene textos paralelos que
enseñan cómo utilizar las estructuras del Glosa. Muchos ejercicios <!-- original was: ejericios -->
para practicar la traducción directa e indirecta.
...
útiles en el vocabulario fundamental del Glosa 1000. </P>

<P>**Lectores:** los que prefieren trabajar sistemáticamente
con ejercicios; a partir de los 12 años, y mayores. </P>



<H3>INTRODUCING EURO-GLOSA</H3>

<P>Contiene 16 textos paralelos en Glosa e Inglés sobre
lenguaje y comunicación, temas ecológicos, prosa, y un
cuento breve. </P>

<H3>CASSETTE</H3>

<P>Para acompañar "Introducing Euro-Glosa". 60 minutos;
...
contenido en un elegante estuche plástico con cremallera. </P>
...
<P>**6000 Greek and Latin Words and Roots which occur in the
Euro-languages and International Scientific Terminology**</P>
...
<P>**Contenido:** Se incluyen dos vocabularios: Glosa 1000 en
...
<P>ISSN 0265-6892 <!-- original was: ISBN -->
</P>

<P> Este boletín mantiene los contactos entre los 'Glosistas',
...
<P>La GEO, organización sin beneficios economicós,
...
rápida de los idiomas europeos. </P>





<P> Para información más detallada, escribir a </P>
...
<P>**TODOS  LOS  RADICALES  GRECOLATINOS 
DE  GLOSA  YA  SE  CONOCEN 
INTERNACIONALMENTE,  PUESTO  QUE  LA 
MEDICINA,  LA  CIENCIA  Y  LA 
TECNOLOGÍA  MODERNAS  LOS  DIFUNDEN 
POR  TODAS  PARTES  DEL  MUNDO.**</P>

<UL>
<LI> En la <A HREF="esintra.htm#exempla">portada</A> aparecen cincuenta radicales grecolatinos de Glosa.
<LI> Seguro que estás de acuerdo: los aprenderás con facilidad.
<LI> En Glosa 1000 sólo hay mil palabras, todas tan fácilmente memorizables como estas cincuenta.
<LI> Dichas mil palabras bastan para conversar sobre cualquier tema, desde lo más corriente hasta lo más literario y científico.
</UL>
